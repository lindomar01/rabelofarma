...
public class FabricanteDAO {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("Os fabricantes foram salvos "); } catch
		 * (SQLException e) { System.out.println("Não foi possível salvar ");
		 * e.printStackTrace(); }
		 */
		  ...
		  Fabricante f2 = new Fabricante(); f2.setCodigo(4L);
		  
		  FabricanteDAO fdao = new FabricanteDAO();
		  
		  try { fdao.excluir(f1); fdao.excluir(f2);
		  System.out.println("Os fabricantes foram removidos "); } catch
		  (SQLException e) {
		  System.out.println("Não foi possível excluir os fabricantes ");
		  e.printStackTrace(); }*/
		 

		/*
		 * Fabricante f1 = new Fabricante(); f1.setCodigo(3L);
		 * f1.setDescricao("DESCRICAO 4");
		 * 
		 * FabricanteDAO fdao = new FabricanteDAO();
		 * 
		 * try { fdao.editar(f1);
		 ...
		 * (SQLException e) {
		 * System.out.println("Ocorreu erro ao editar o fabricante ");
		 * e.printStackTrace(); }
		 */
		 ...
		 * System.out.println("Ocorreu um erro"); e.printStackTrace(); }
		 */
		...
		try{
			...
			System.out.println("ocorreu um erro ao perquisar um fabricante");
			e.printStackTrace();
		}*/
	}
}
